...
def main():
    ...
    if selection == "Exploratory Data Analysis and Insights":
        ...
        from PIL import Image
        image1 = Image.open('Images/format_of_data.png')
        ...
        from PIL import Image
        image2 = Image.open('Images/dis_classes.png')
        ...
        from PIL import Image
        image3 = Image.open('Images/bar_sent.png')
        st.image(image3, caption='Count of sentiment expressions')

        st.write("  Next, lets investigate into the number of unique words used in each class.")

        from PIL import Image
        image4 = Image.open('Images/box_plot.png')
        st.image(image4, caption='Number of words for corresponding sentiment class')
        ...
        from PIL import Image
        image5 = Image.open('Images/word_length.png')
        ...
        from PIL import Image
        image6 = Image.open('Images/freq.png')
        st.image(image6, caption='Frequencies of Hashtags, Mentions, URL links and Retweets')
        ...
        from PIL import Image
        image7 = Image.open('Images/Wordclouds.png')
        ...
        from PIL import Image
        image9 = Image.open('Images/at.png')
        st.image(image9, caption='')
        from PIL import Image
        image10 = Image.open('Images/hashtag.png')
        st.image(image10, caption='')
        ...
        from PIL import Image
        image11 = Image.open('Images/polarity.png')
        st.image(image11, caption='Polarity in subjectivity of the classes')
